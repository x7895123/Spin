...
namespace EasyUI.PickerWheelUI
{
    ...
    public class PickerWheel : MonoBehaviour
    {
        ...
        private void DrawPiece(int index)
        {
            ...
            pieceTrns.GetChild(2).GetComponent<Text>().text = piece.Label;
            pieceTrns.GetChild(2).GetComponent<Text>().color = piece.LabelColor;
            pieceTrns.GetChild(4).GetComponent<Text>().text = piece.Amount.ToString();
            
            //            Label = pieceTrns.GetChild(1).GetComponent<Text>();
            //            Label.text = piece.Label;
            //            Label.color = piece.LabelColor;
            //pieceTrns.GetChild(0).GetChild(0).GetComponent<Text>().text = piece.Label;
            //pieceTrns.GetChild(0).GetChild(0).GetComponent<Text>().color = piece.LabelColor;
            ...
            //Vector3 oldPos = pieceTrns.GetChild(0).GetChild(0).transform.position;
            pieceTrns.RotateAround(wheelPiecesParent.position, Vector3.back, pieceAngle * index);
            //pieceTrns.GetChild(0).GetChild(0).RotateAround(wheelPiecesParent.position, Vector3.forward, 0);
        }
...
//            rand = new System.Random();
            ...
            //Debug.Log("start accumulatedWeight: " + accumulatedWeight);
            r = r * accumulatedWeight;
            //Debug.Log("r: " + r);


            for (int i = 0; i < wheelPieces.Length; i++)
            {
                //Debug.Log(wheelPieces[i].Label + " weigth=" + wheelPieces[i]._weight + "  r: " + r);
        ...
        private void CalculateWeightsAndIndices()
        {
            ...
            for (int i = 0; i < wheelPieces.Length; i++)
            {
                ...
                //Debug.Log(piece.Label + ": " + piece._weight);
            ...
            //Debug.Log("accumulatedWeight: " + accumulatedWeight);
        }
